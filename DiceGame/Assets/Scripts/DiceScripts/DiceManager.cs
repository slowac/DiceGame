...
public class DiceManager : MonoBehaviour
{
    ...
    private List<Vector3> initialDicePositions = new List<Vector3>(); //zarlarýn baþlangýç pozisyonlarýný ve tüm zarlarý tutmak için kullanýlýr.
    private List<Transform> Dices = new List<Transform>(); // zarlarýn baþlangýç pozisyonlarýný ve tüm zarlarý tutmak için kullanýlýr.
    private Quaternion rotation;
    private Vector3 force;
    private Vector3 torque;


    [SerializeField] private int simulationFrameLength = 50; // Bu deðiþken, zar atma iþlemi sýrasýnda simülasyonun kaç adet çerçeve (frame) boyunca yapýlacaðýný belirler.
    [SerializeField] private int optimizationCount = 2; // Bu deðiþken, her bir simülasyon çerçevesinin kaç adet alt çerçeveye bölüneceðini belirler.
...
#if UNITY_EDITOR
    private void OnValidate() //  Unity Editör'ünde yapýlan deðiþiklikleri kontrol eder ve belirli bir þart saðlanmazsa bir hata mesajý verir.
    {
